		...
		<>
			<div className='h-screen flex justify-between'>
				<div
					...
					style={{ backgroundImage: `linear-gradient(rgba(37,99,235,0.85),rgba(15,23,42,0.9)), url(${BgImage})` }}>
					...
					<div className='text-lg text-text-secondary flex justify-start mt-auto'>© 2026 BeliMudah. Seluruh hak cipta dilindungi.</div>
				</div>
				<div className='w-1/2 h-full p-30 flex flex-col justify-center items-center'>
					<div className='w-2/3 flex flex-col gap-4 justify-center items-start mb-10'>
						...
						<div className='w-full flex flex-col justify-center items-start gap-2 mt-4 mb-2'>
							...
							<div className='text-xl text-text-secondary mb-1'>Tidak perlu khawatir. Masukkan email yang terdaftar dan kami akan mengirimkan tautan untuk membuat kata sandi baru.</div>
						</div>
